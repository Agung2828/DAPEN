    ...
    <header class="main-header" id="mainHeader">
        <div class="container">
            ...
            <div class="mobile-nav" id="mobileNav">
                ...
                <a href="#" class="mobile-link" onclick="showPage('Galeri')">Galeri</a>
                <a href="#" class="mobile-link" onclick="showPage('berita')">Berita</a>
            </div>
    ...
    <div id="home" class="page-content active">
        ...
        <div class="main-content">
                ...
                <div class="news-grid">
                    ...
                    <div class="news-card tab-{{ strtolower($item->kategori) }}">
                        <div class="news-image1">
                            ...
                            @if ($fotoName)
                            <img src="{{ asset('uploads/berita/' . rawurlencode($fotoName)) }}" alt="Foto Berita">
                            @else
            ...
            <section class="why-choose">
                <div class="container">
                    <h2 class="section-title" style="text-align: center;">Mengapa Memilih Dana Pensiun Bank Riau Kepri</h2>
                    <p class="section-subtitle" style="text-align: center;">
                        Melayani lebih dari 25 tahun, Dana Pensiun Bank Riau Kepri senantiasa memberikan kemudahan dan kecepatan
            ...
            tabs.forEach(tab => {
                tab.addEventListener("click", () => {
                    ...
                    cards.forEach(card => {
                        ...
                        if (filter !== "semua" && !card.classList.contains("tab-" + filter)) {
